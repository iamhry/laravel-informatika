...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/template/assets/css/fontawesome.css')}}">
    <link rel="stylesheet" href="{{asset('assets/template/assets/css/templatemo-villa-agency.css')}}">
    <link rel="stylesheet" href="{{asset('assets/template/assets/css/owl.css')}}">
    <link rel="stylesheet" href="{{asset('assets/template/assets/css/animate.css')}}">
...
<script src="{{asset('assets/template/assets/js/isotope.min.js')}}"></script>
<script src="{{asset('assets/template/assets/js/owl-carousel.js')}}"></script>
<script src="{{asset('assets/template/assets/js/counter.js')}}"></script>
<script src="{{asset('assets/template/assets/js/custom.js')}}"></script>
